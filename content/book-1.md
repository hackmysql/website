...
params:
  path: qrt
  description: "Configuring MySQL query metrics (slow query log, Performance Schema) is skipped in most books but critical in practice. This post covers what chapter 1 of Efficient MySQL Performance left out."
---
